...
{
    // Add Task to Setup tab's Default Routes Panel's task widget.
    [CommandPlugIn(new string[1] { "DefaultRoutesCommands" })]
    public class EditCommonDefaultRoutePropertiesCmd : AppCommands.ICommand
    {
        ...
        public string Name
        {
            get { return "EditCommonPropertiesPlugin.EditCommonDefaultRoutePropertiescmd"; }
        }
        ...
        List<string> itemList = new List<string> { "Route Name", "Vehicle", "Driver", "Max Orders", "Start Time Window Start", "Start Time Window Finish", "Max Travel Distance", "Max Travel Duration", "Max Total Duration", "Start Location", "Time At Start", "End Location", "Time At End", "Renewal Locations", "Time At Renewal", "Zones", "Hard Zones", "Comment" };
