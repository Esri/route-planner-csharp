...
{
    /// <summary>
    /// Class that represents a driver specialty.
    /// </summary>
    /// <remarks>
    /// Typically driver specialty is a driver skill. For example, it may be a license to carry hazardous materials.
    /// </remarks>
    public class DriverSpecialty : DataObject, IMarkableAsDeleted,
        ISupportOwnerCollection
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <c>DriverSpecialty</c> class.
        /// </summary>
        public DriverSpecialty()
            : base(DataModel.DriverSpecialties.CreateDriverSpecialties(Guid.NewGuid()))
        {
        ...
        {
            get { return Properties.Resources.DriverSpecialty; }
        }
        ...
        /// <summary>
        /// Arbitrary text about the driver specialty.
        /// </summary>
        ...
        ///////////////////////////////////////////////////////////////////////////////////////////
        /// <summary>
        /// Returns the name of the driver specialty.
        /// </summary>
        /// <returns></returns>
        ...
        private DataModel.DriverSpecialties _Entity
        {
            get
            {
                return (DataModel.DriverSpecialties)base.RawEntity;
            }
        }
